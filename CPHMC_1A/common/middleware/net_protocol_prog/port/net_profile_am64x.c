...
#if defined(NET_PROFILE_AM64X_BUILD)

/**
 * @brief 查询AM64X平台是否启用组网功能。
 * @return 固定返回true
 */
...
/**
 * @brief 查询AM64X构建是否启用CAN数据转发。
 * @return true表示AM64x R5F0启用，false表示当前目标禁用
 */
...
/**
 * @brief 查询AM64X平台是否允许R5F1核心使用CAN通道。
 * @return 固定返回false
 */
