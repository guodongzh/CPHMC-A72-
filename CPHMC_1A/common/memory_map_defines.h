...
#define MCU1_FAST_DATA_BASE    (LINUX_ENT_FLAG_BASE + LINUX_ENT_FLAG_SIZE)

/* per-core reserve */
#define CORE_RESERVE_SIZE      0x8000 /* 32KB */
#define CORE_RESERVE_START     (MCU1_FAST_DATA_BASE + FAST_DATA_SIZE)
#define R0_CORE_RESERVE_BASE   CORE_RESERVE_START
#define R1_CORE_RESERVE_BASE   (R0_CORE_RESERVE_BASE + CORE_RESERVE_SIZE)
#define R2_CORE_RESERVE_BASE   (R1_CORE_RESERVE_BASE + CORE_RESERVE_SIZE)
#define R3_CORE_RESERVE_BASE   (R2_CORE_RESERVE_BASE + CORE_RESERVE_SIZE)
#define C60_CORE_RESERVE_BASE  (R3_CORE_RESERVE_BASE + CORE_RESERVE_SIZE)
#define C61_CORE_RESERVE_BASE  (C60_CORE_RESERVE_BASE + CORE_RESERVE_SIZE)
#define C70_CORE_RESERVE_BASE  (C61_CORE_RESERVE_BASE + CORE_RESERVE_SIZE)
#define MCU1_CORE_RESERVE_BASE (C70_CORE_RESERVE_BASE + CORE_RESERVE_SIZE)

/* TFR MEM (MCU1_1) */
#define MCU1_TFR_MEM_BASE        (MCU1_CORE_RESERVE_BASE + CORE_RESERVE_SIZE)
